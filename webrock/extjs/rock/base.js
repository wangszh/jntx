...
Ext.define('Ext.rock.changedeptuser',{
	...
	onTrigger2Click:function(e){			
		...
		//if(typeof(CHANGEUSERTREE)!='object'){
			var cans = winopt({title: this.changetitle,width:350,items:{
				...
				params:{changetype:this.changetype,changetozw:this.changetozw,changetopdid:this.changetopdid},
				bbar:[{
	...
	setchangetopdid:function(did){
		this.changetopdid = did;
	},
	getchangetopdid:function(){
		return this.changetopdid;
	},
	setchangetozw:function(zw){
		this.changetozw = zw;
	},
	getchangetozw:function(){
		return this.changetozw;
	},
	_searchsou:function(){
