...
homeitems.todo = {
	...
	storeafteraction:'jisanstatela',fields:['xuhao','optdt','status','table','mid'],id:'homeitemstodo',
	columns:[{
		text:'',dataIndex:'xuhao',width: 35
	},{
		text:'类型',dataIndex:'title',width:80,renderer:huirendhi
	},{
		text:'内容',dataIndex:'mess',flex:1,align:'left',renderer:huirendhi
	},{
		text:'时间',dataIndex:'optdt',width:100,renderer:huirendhi
	}],
	load:function(){
