...
function opentablss(a){
	//addtabs('[新增]'+a.name,'flow,apply,'+a.num+',flownum='+a.num+',tablename='+a.table+',opentype=0,mid=0,gridid=', ''+a.num+'_0');return;
	//alert(a.num)
	//debugger;
	openiframe('[新增]'+a.name, a.num,{icon:gicons('add')});
}
...
var panel = {
	bbarbool:false,xtype:'rockgrid',tablename:'flow_set',defaultorder:'`sort`',pageSize:100,
	...
	columns:[{
		...
		items: [{
			...
			tooltip: '新增申请',
			handler: function(grid, rowIndex, colIndex, s, b) {
