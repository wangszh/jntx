...
class adminClassAction extends Action
{
	...
	{
		return array(
			'fields' => 'id,user,name,idnum,cardid,tel,email,status,groupname,gender,mobile,type,zwid,ranking,superman,superid,deptid,deptname,sort,quitdt,status,type,state,workdate,isdaily,isvcard,positivedt,syenddt,companyid,weixinid'
		);
	}
