...
//从这里可以获取动作路径  如：/webrock/index/indexAction.php
//echo '<br>动作路径:'.$actfile.'<br>';
//return;
...
//可以调用动作的类和方法　在$actfile指定的文件中定义    如：defaultAction
//echo '<br>类名:'.$clsname.'   方法名:'.$actname.'<br>';
//return;
...
if($xhrock->display && ($ajaxbool == 'html' || $ajaxbool == 'false')){
	...
	//这里获取模板文件路径  如：/webrock/index/tpl_index.html  如果返回结果是ＪＳ或ＡＪＡＸ则这里不显示
	//echo '<br>模板:'.$mpathname.'<br>';
	//return;
